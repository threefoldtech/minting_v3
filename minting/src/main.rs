...
async fn main() {
    ...
    if period_offset != 73 {
        panic!("This binary can only be used for the correction of period 73");
    }
    ...
    let existing_receipt_dir = path::PathBuf::from("receipts/73");
    println!("Loading existing receipts from period 73");
